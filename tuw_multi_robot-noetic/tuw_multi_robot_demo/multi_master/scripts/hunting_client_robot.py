...
while not rospy.is_shutdown():
    rospy.Subscriber('aruco_single/pose',PoseStamped,robot_move_Callback)
    rospy.Subscriber('robot_pose_ekf/odom_combined',PoseWithCovarianceStamped,robot_move_Callback)
    r.sleep()
    r.sleep()
