...
def recv_msg(sock):
    try:
        ...
        print("robot1_map receive id: ",id)
...
map_socket.bind(('',9001))
map_socket.listen(10)
 
(client,address) = map_socket.accept()
 
rospy.init_node("map_client_robot1")
map_pub = rospy.Publisher("/tb3_1/map",OccupancyGrid,queue_size=100)
map_up_pub = rospy.Publisher("/tb3_1/map_updates",OccupancyGridUpdate,queue_size=100)
r = rospy.Rate(1000)
