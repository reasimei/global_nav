...
#pose_socket.connect(('127.0.0.1',pose_com))
    ...
    while not rospy.is_shutdown():
        try:
            ...
            #p1 = PoseStamped()            
            #p1.pose.position.x = Num[1]
            #p1.pose.position.y = Num[2]+1.2
            #p1.pose.orientation.z = Num[3]
            #p1.pose.orientation.w = Num[4]
            #p1.header.frame_id = '/odom'
            #p_in_map = listener.transformPose("/map",p1)
            data=""
            #Data[0]=p_in_map.pose.position.x
            #Data[1]=p_in_map.pose.position.y
            #Data[2]=p1.pose.orientation.z
            #Data[3]=p1.pose.orientation.w
            Data[0]=Num[1]
            Data[1]=Num[2]-1.2
            Data[2]=Num[3]
            Data[3]=Num[4]
