...
def recv_msg(sock):
    try:
        ...
        print("robot3_map receive id: ",id)
...
map_socket.bind(('',9003))
map_socket.listen(10)
 
(client,address) = map_socket.accept()
 
rospy.init_node("map_client_robot3")
map_pub = rospy.Publisher("/tb3_3/map",OccupancyGrid,queue_size=100)
map_up_pub = rospy.Publisher("/tb3_3/map_updates",OccupancyGridUpdate,queue_size=100)
r = rospy.Rate(1000)
