...
def recv_msg(sock):
    try:
        ...
        print("robot2_map receive id: ",id)
...
map_socket.bind(('',9002))
map_socket.listen(10)
 
(client,address) = map_socket.accept()
 
rospy.init_node("map_client_robot2")
map_pub = rospy.Publisher("/tb3_2/map",OccupancyGrid,queue_size=100)
map_up_pub = rospy.Publisher("/tb3_2/map_updates",OccupancyGridUpdate,queue_size=100)
r = rospy.Rate(1000)
